...
public class F18 {
    public static JSONArray getCommands(ArrayList<Coordinate> coords){
        ...
        //select PRECISE
        commandArray.put(new JSONObject().put("device", "37").put("code", "3029").put("delay", "10").put("activate", "1"));
        ...
        for (Coordinate coordinate:coords) {
            ...
            //start entering first 4 latitude digits
            ...
            //press E east
            commandArray.put(new JSONObject().put("device", "25").put("code", "3024").put("delay", "0").put("activate", "1"));
            //start entering first 4 longitude digits
